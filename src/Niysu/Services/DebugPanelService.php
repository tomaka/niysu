		...
		'<div style="color:black; position:fixed; left:0; bottom:0; width:100%; padding:0.5em 1em; background-color:gray; border-top:3px double black;">
			...
			<span style="margin-left:2em;">
				...
				>
					...
					<div style="display:none; background-color:#eee; border:2px solid black; border-radius:5px; padding:1em 2em; position:absolute; bottom:0.7em; left:-300px; width:600px; max-height:40em; overflow-y:auto;">
						$queriesInfosHTML
					</div>
				</span>
			</span>
